                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                                ...
                                <span className="inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded text-[10px] sm:text-xs font-semibold bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300">
                                    {dataSourceMode === 'google' ? 'Live Google Sheet' : 'Excel Mode'}
                                </span>
                            </div>
                            <div className="flex flex-wrap items-center gap-x-2.5 gap-y-0.5 text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                {formattedSyncTime && (
