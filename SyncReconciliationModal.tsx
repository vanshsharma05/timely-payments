            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[92vh] flex flex-col border border-gray-100 dark:border-gray-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <span className="font-bold text-sm text-gray-900 dark:text-white">🛡️ Keep Earlier Assigned CRM</span>
                                <input
                                    type="radio"
                                    name="crm_strategy"
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <span className="font-bold text-sm text-gray-900 dark:text-white">✏️ Custom Per-Customer</span>
                                <input
                                    type="radio"
                                    name="crm_strategy"
                                        ...
                                        >
                                            <td className="px-4 py-2.5 font-medium text-gray-900 dark:text-white">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    {!row.isMatched && (
                                                        <span className="px-1.5 py-0.2 rounded text-[10px] font-bold bg-green-100 dark:bg-green-900/60 text-green-700 dark:text-green-300">
                                                            NEW
                                                        </span>
                                                    )}
                                                    {hasConflict && (
                                                        <span className="px-1.5 py-0.2 rounded text-[10px] font-bold bg-amber-100 dark:bg-amber-900/60 text-amber-800 dark:text-amber-300">
                                                            CRM DIFF
                                                        </span>
                                                    )}
                                                </div>
                ...
                <div className="p-4 sm:px-6 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-3">
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                        🛡️ <strong>Note:</strong> All follow-up history, notes, next follow-up dates, and collector assignments are safely preserved.
                    </div>
                    <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
                        ...
                        >
                            ...
                            <span className="px-1.5 py-0.5 rounded-full bg-green-700 text-[10px]">
