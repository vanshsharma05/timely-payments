...
export const AiReportModal: React.FC<AiReportModalProps> = ({
    ...
    return (
        <DialogShell
            ...
            subtitle={hasApiKey
                ? `Written by Google Gemini from the accounts in this report · ${companyProfile.name} · ${scopedData.length} accounts`
                : `Written by the built-in analysis (add GEMINI_API_KEY for the AI version) · ${companyProfile.name} · ${scopedData.length} accounts`}
            icon={<SparklesIcon className="w-5 h-5" />}
            size="xl"
            onClose={onClose}
            headerExtra={reportResult && activeTab === 'report' ? (
                <Button size="sm" variant="quiet" onClick={() => setActiveTab('configure')}>Settings</Button>
            ) : undefined}
            footerNote="Read on screen, copy, or print. Nothing here changes an account."
            footer={<Button type="button" variant="quiet" onClick={onClose}>Close</Button>}
        >
                        ...
                        <div className="space-y-6 max-w-4xl mx-auto">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-center text-xs">
                                        <div className="p-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                            <span className="text-gray-500 dark:text-gray-400 block text-[11.5px]">Total Due</span>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <span className="font-bold text-sm text-gray-900 dark:text-white flex items-center gap-1.5">
                                                    ...
                                                    <span className="px-1.5 py-0.5 rounded text-[11.5px] font-extrabold bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200">Recommended</span>
                                                </span>
                            ...
                            <div className="pt-2 flex justify-end">
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex items-center gap-2 px-6 py-3 bg-accent hover:bg-accent-press text-on-accent font-semibold rounded-full transition-colors text-sm"
                                >
                        ...
                        <div className="space-y-6">
                            {isLoading ? (
                                <div className="py-20 text-center space-y-4">
                                    <div className="inline-block p-4 bg-emerald-100 dark:bg-emerald-950/60 rounded-full text-emerald-600 dark:text-emerald-400 animate-spin">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 mb-4 print:hidden">
                                        <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300">
                                            ...
                                            <span className="px-2 py-0.5 rounded bg-emerald-100 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-300 font-mono text-[12.5px] font-bold">
