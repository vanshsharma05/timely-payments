...
export const CompanyBanner: React.FC<CompanyBannerProps> = ({ 
    ...
    return (
        <div className="bg-accent text-white rounded-2xl shadow-lg p-4 sm:p-6 mb-6 border border-slate-700/50 relative overflow-hidden">
                ...
                <div className="flex items-start sm:items-center gap-3.5 sm:gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[12.5px] font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/40">
