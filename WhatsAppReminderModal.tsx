...
import { WhatsAppIcon, BuildingOfficeIcon } from './icons/Icons';
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-3 sm:p-4 overflow-y-auto backdrop-blur-xs">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg flex flex-col border border-gray-200 dark:border-gray-800 my-auto animate-in fade-in zoom-in-95 duration-150">
                ...
                <div className="p-5 space-y-4 text-xs">
                    {/* Recipient Selection */}
                    <div>
                        <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300 mb-1.5">
                            ...
                            <label className={`flex items-center justify-between p-2.5 rounded-lg border cursor-pointer transition-all ${
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[11px] text-gray-500 font-medium">📞 {customer.contactNumber || 'No number'}</div>
                                    </div>
                                </div>
                                <span className="px-1.5 py-0.5 rounded text-[10px] bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 font-semibold">Primary</span>
                            </label>
                                ...
                                <label key={c.id} className={`flex items-center justify-between p-2.5 rounded-lg border cursor-pointer transition-all ${
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[11px] text-gray-500 font-medium">📞 {c.mobile}</div>
                                        </div>
                                    </div>
                                    <span className="px-1.5 py-0.5 rounded text-[10px] bg-emerald-100 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-200 font-semibold">{c.post || 'Contact'}</span>
                                </label>
                            ))}
                            ...
                            <label className={`flex items-center justify-between p-2.5 rounded-lg border cursor-pointer transition-all ${
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[11px] text-gray-500 font-normal">Specify another person in same company</div>
                                    </div>
                                </div>
                            </label>
                        </div>
                        ...
                        {recipientType === 'custom' && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2 p-2.5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-green-300 dark:border-green-700">
                                <div>
                                    <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-300 mb-0.5">Person Name (Optional)</label>
                                    <input
                                        type="text"
                    ...
                    <div>
                        ...
                        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 text-[11px] text-gray-700 dark:text-gray-300 font-mono whitespace-pre-wrap max-h-32 overflow-y-auto leading-relaxed">
