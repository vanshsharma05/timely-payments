...
import { WhatsAppIcon, CalendarIcon, UserPlusIcon, ChequeIcon, TrashIcon, EditIcon, CheckCircleIcon, BuildingOfficeIcon, SparklesIcon } from './icons/Icons';
...
const FollowUpModal = ({ 
    ...
    const [primaryPerson, setPrimaryPerson] = useState(customer.contactPerson || '');
    const [primaryNumber, setPrimaryNumber] = useState(customer.contactNumber || '');
                ...
                <div className="p-5 sm:p-6 overflow-y-auto space-y-5 flex-1">
                    ...
                    <div className="p-3.5 bg-slate-50 dark:bg-gray-800/80 rounded-xl border border-gray-200 dark:border-gray-700 text-xs shadow-xs">
                        <div className="flex justify-between items-baseline mb-2">
                            <span className="text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider text-[11px]">Total Outstanding Balance:</span>
                            <BalanceAmount
                        ...
                        <div className="grid grid-cols-4 gap-2 pt-2 border-t border-gray-200 dark:border-gray-700 text-center">
                            <div className="p-1.5 rounded bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
                                <div className="text-[10px] font-bold text-gray-400 uppercase">1-45d</div>
                                <BalanceAmount
                            ...
                            <div className="p-1.5 rounded bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
                                <div className="text-[10px] font-bold text-gray-400 uppercase">46-90d</div>
                                <BalanceAmount
                            ...
                            <div className="p-1.5 rounded bg-amber-50/80 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900">
                                <div className="text-[10px] font-bold text-amber-700 dark:text-amber-300 uppercase">91-135d</div>
                                <BalanceAmount
                            ...
                            <div className="p-1.5 rounded bg-red-50/80 dark:bg-red-950/40 border border-red-200 dark:border-red-900">
                                <div className="text-[10px] font-extrabold text-red-700 dark:text-red-300 uppercase">&gt;135d 🚨</div>
                                <BalanceAmount
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="p-2.5 rounded-lg bg-white dark:bg-gray-800 border border-blue-100 dark:border-blue-900/60 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                                <div className="space-y-0.5">
                                    <div className="flex items-center gap-2">
                                        <span className="px-1.5 py-0.2 rounded text-[10px] font-bold bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Primary</span>
                            ...
                            {additionalContacts.map((contact) => (
                                <div key={contact.id} className="p-2.5 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-between gap-2 text-xs">
                                    <div className="space-y-0.5">
                                        <div className="flex items-center gap-2">
                                            <span className="px-1.5 py-0.2 rounded text-[10px] font-bold bg-emerald-100 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-200">
                                        ...
                                        <div className="text-gray-600 dark:text-gray-300 font-medium flex items-center gap-2">
                                            ...
                                            {contact.email && <span className="text-gray-400">✉️ {contact.email}</span>}
                                        </div>
                                    </div>
                                    <button
                                        type="button"
                        ...
                        {showAddContactForm && (
                            <form onSubmit={handleAddContact} className="p-3 bg-white dark:bg-gray-800 rounded-xl border border-blue-300 dark:border-blue-700 space-y-2 text-xs animate-in fade-in duration-150">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <div>
                                        <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-300 mb-0.5">Person Name *</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-300 mb-0.5">Mobile Number *</label>
                                        <input
                                            type="tel"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <div>
                                        <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-300 mb-0.5">Post / Designation *</label>
                                        <select
                                    ...
                                    <div>
                                        <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-300 mb-0.5">Email (Optional)</label>
                                        <input
                                            type="email"
                    ...
                    <div className="p-4 bg-green-50/60 dark:bg-green-950/20 rounded-xl border border-green-200 dark:border-green-800/60 space-y-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                                ...
                                <label className={`flex items-start gap-2 p-2 rounded-lg border cursor-pointer transition-all ${
                                    ...
                                    <div className="truncate">
                                        ...
                                        <div className="text-[11px] text-gray-500 dark:text-gray-400">{primaryNumber || 'No phone set'}</div>
                                    </div>
                                </label>
                                ...
                                {additionalContacts.map(c => (
                                    <label key={c.id} className={`flex items-start gap-2 p-2 rounded-lg border cursor-pointer transition-all ${
                                        ...
                                        <div className="truncate">
                                            ...
                                            <div className="text-[11px] text-gray-500 dark:text-gray-400">{c.mobile}</div>
                                        </div>
                                    </label>
                                ))}
                                ...
                                <label className={`flex items-start gap-2 p-2 rounded-lg border cursor-pointer transition-all ${
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[11px] text-gray-500 dark:text-gray-400">Specify alternative number</div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div className="space-y-2 pt-1">
                            <label htmlFor="templateSelect" className="block text-[11px] font-bold text-gray-700 dark:text-gray-300">
                                Reminder Template:
                            </label>
                            <select
                                id="templateSelect"
                                                ...
                                                <div key={pdc.id} className="flex items-center justify-between p-2 rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-xs">
                                                    <div className="flex flex-col">
                                                        <div className="flex items-center gap-1.5 font-semibold text-gray-800 dark:text-gray-200">
                                                            ...
                                                            <span className="text-[11px] font-normal text-gray-500 dark:text-gray-400">({pdc.bankName})</span>
                                                        </div>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {onUpdatePdcStatus && pdc.status !== PdcStatus.Cleared && (
                                                            <button
                                                                ...
                                                                className="px-1.5 py-0.5 text-[10px] bg-emerald-100 hover:bg-emerald-200 text-emerald-700 rounded font-semibold transition-colors"
                                                                title="Mark Cleared"
                                                            >
                                                                ✓ Clear
                                                            </button>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                                <label className={`flex items-center p-2.5 rounded-xl border cursor-pointer transition-all ${
                                    ...
                                    <input type="radio" name="outcome" value="follow_up" checked={outcome === 'follow_up'} onChange={() => setOutcome('follow_up')} className="mr-2 text-green-600"/>
                                ...
                                <label className={`flex items-center p-2.5 rounded-xl border cursor-pointer transition-all ${
                                    ...
                                    <input type="radio" name="outcome" value="collected" checked={outcome === 'collected'} onChange={() => setOutcome('collected')} className="mr-2 text-emerald-600"/>
                            ...
                            <div className="p-4 bg-emerald-50/70 dark:bg-emerald-950/30 rounded-xl border border-emerald-300 dark:border-emerald-700 space-y-3 animate-in fade-in duration-150">
                                <div className="flex items-center justify-between">
                                    ...
                                    {forecastAmount && parseFloat(forecastAmount) > 0 && (
                                        <span className="px-2 py-0.5 rounded-full text-[11px] font-extrabold bg-emerald-200 dark:bg-emerald-900 text-emerald-900 dark:text-emerald-200">
                                ...
                                <div className="flex flex-wrap items-center gap-1.5 pt-1">
                                    <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase mr-1">Quick Presets:</span>
                                    <button
                                        type="button"
                                        onClick={() => handleSetPresetForecast(customer.total)}
                                        className="px-2 py-0.5 rounded text-[11px] font-semibold bg-emerald-100 hover:bg-emerald-200 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-200 transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="px-2 py-0.5 rounded text-[11px] font-semibold bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100"
                                    >
                                        ₹1 Lakh
                                    </button>
                                    <button
                                ...
                                <div className="flex items-center pt-1">
                                    <label htmlFor="isUrgent" className="flex items-center cursor-pointer">
                                        <input 
                                            ...
                                            className="rounded text-red-600 focus:ring-red-500 w-4 h-4 mr-2"
                                        />
