        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xs border border-gray-200 dark:border-gray-800 overflow-hidden mb-6">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse text-xs sm:text-sm">
                    <thead className="bg-gray-50 dark:bg-gray-800/90 text-[11px] sm:text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                        <tr>
                                ...
                                <td className="px-3.5 py-2.5 whitespace-nowrap">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {stat.crmId === 'Unassigned' && (
                                            <span className="px-1.5 py-0.2 rounded text-[10px] font-bold bg-red-100 text-red-700 dark:bg-red-900/60 dark:text-red-300">
                                                Assign CRM
                                            </span>
                                        )}
                                    </div>
