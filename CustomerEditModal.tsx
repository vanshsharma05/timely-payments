            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col border border-gray-200 dark:border-gray-800 animate-in fade-in zoom-in-95 duration-150 my-auto">
                ...
                <div className="p-5 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50 rounded-t-2xl">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            <span>{isNew ? '🏢 Add New Customer' : '✏️ Edit Customer Master'}</span>
                        </h2>
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1">
                                CRM Owner <span className="text-red-500">*</span>
                            </label>
                            {canReassignCrm ? (
                                <select
                                    value={crmOwnerId}
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-gray-800/40 rounded-xl border border-slate-200 dark:border-gray-700/80 space-y-3">
                        <div className="text-xs font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wider flex items-center justify-between">
                            ...
                            <span className="text-[10px] text-gray-500 font-normal">Main point of contact for follow-up</span>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Contact Name</label>
                                <input
                                    type="text"
                                    value={contactPerson}
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Designation / Role</label>
                                <input
                                    type="text"
                                    value={contactPost}
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Mobile / Phone Number</label>
                                <input
                                    type="text"
                                    value={contactNumber}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Email Address</label>
                            <input
                                type="email"
                                value={email}
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-gray-800/40 rounded-xl border border-slate-200 dark:border-gray-700/80 space-y-3">
                        <div className="text-xs font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wider flex items-center justify-between">
                            <span>🏛️ Master Information (GSTIN, Address & Credit Terms)</span>
                            <span className="text-[10px] text-gray-500 font-normal">Master ledger profile</span>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">GSTIN Number</label>
                                <input
                                    type="text"
                                    value={gstin}
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">City / Region</label>
                                <input
                                    type="text"
                                    value={city}
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">State</label>
                                <input
                                    type="text"
                                    value={state}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Sanctioned Credit Limit (₹)</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Credit Terms (Days)</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Billing / Plant Address</label>
                                <input
                                    type="text"
                                    value={address}
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-gray-800/40 rounded-xl border border-slate-200 dark:border-gray-700/80 space-y-3">
                        <div className="text-xs font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wider flex items-center justify-between">
                            ...
                            <span className="text-[10px] text-gray-500 font-normal">Add Purchase, Billing, Factory heads</span>
                        </div>
                                ...
                                {additionalContacts.map(c => (
                                    <div key={c.id} className="flex items-center justify-between p-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 text-xs">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {c.post && <span className="px-1.5 py-0.2 rounded bg-blue-100 dark:bg-blue-900/60 text-blue-800 dark:text-blue-200 text-[10px] font-semibold">{c.post}</span>}
                                            <span className="text-gray-500 dark:text-gray-400">📞 {c.mobile}</span>
                                            {c.email && <span className="text-gray-400 text-[10px]">✉️ {c.email}</span>}
                                        </div>
                                        <button
                                            type="button"
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-gray-800/40 rounded-xl border border-slate-200 dark:border-gray-700/80 space-y-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                                <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Total Outstanding (₹)</label>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                            <div>
                                <label className="block text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-0.5">1-45 Days (₹)</label>
                                <input
                                    type="number"
                                    value={a1_45}
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-0.5">46-90 Days (₹)</label>
                                <input
                                    type="number"
                                    value={a46_90}
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-0.5">91-135 Days (₹)</label>
                                <input
                                    type="number"
                                    value={a91_135}
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-0.5">&gt;135 Days (₹)</label>
                                <input
                                    type="number"
                                    value={aOver135}
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-gray-800/40 rounded-xl border border-slate-200 dark:border-gray-700/80 space-y-3">
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold text-gray-600 dark:text-gray-400 mb-1">Next Follow-up Date</label>
                            <input
                                type="date"
                                value={followUpDate}
